  ...
  return (
    <>
      ...
      >
        ...
        <span className="absolute -top-2 -left-2 bg-[#151626] text-white text-xs font-bold px-2 py-1 rounded-full transform -rotate-12 group-hover:rotate-0 transition-transform duration-300 glow-text">
          Asistencia con AI
        </span>
      </button>
    </>
